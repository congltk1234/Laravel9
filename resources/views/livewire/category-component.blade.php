                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-action-1 show">
                                        ...
                                        @else  
                                            ...
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up wishlisted" href="#" wire:click.prevent="addToWishlist({{$product->id}}, '{{$product->name}}',  {{$product->regular_price}})"><i class="fi-rs-heart"></i></a>
                                        @endif
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="{{route('product.details',['slug'=>'dress'])}}">Shop Now <i class="fi-rs-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
